...
@TRANSFORMER.register_module()
class DeformableDetrTransformerWithCount(DeformableDetrTransformer):
    ...
    def forward(self,
        ...
        if self.as_two_stage:
            ...
            enc_outputs_count = cnt_branches[self.decoder.num_layers](output_memory)
            enc_outputs_coord_unact = \
                reg_branches[
                    self.decoder.num_layers](output_memory) + output_proposals
        ...
        if self.as_two_stage:
            return inter_states, init_reference_out, inter_references_out, \
                   enc_outputs_class, enc_outputs_coord_unact, enc_outputs_count
        return inter_states, init_reference_out, inter_references_out, \
               None, None, None
